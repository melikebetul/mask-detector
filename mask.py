# -*- coding: utf-8 -*-
"""
Created on Sat May  8 00:59:01 2021
...
for detection_layer in detection_layers:
    for object_det in detection_layer:
        scores=object_det[5:]
        ...
        if confidence>0.30:
            ...
            bounding_box=object_det[0:4]*np.array([img_width,img_height,img_width,img_height])
            ...
            for max_id in max_ids:
                ...
                print("predicted objetct {}".format(label))
